...
* Tue Sep 15 2026 Brian Read <brianr@koozali.org> 11.0.0-264.sme
- Add CSP hash for menu toggle to avoid CSP failure in firefox [SME: 13449]
...
- disconnect user when tkt is missing
...
* Sat Sep 12 2026 Jean-Philippe Pialasse <jpp@koozali.org> 11.0.0-257.sme
- phone validation [SME: 13712]

* Wed Sep 09 2026 Brian Read <brianr@koozali.org> 11.0.0-256.sme
- Revert re-factor to navigation2-conf [SME: 13720]
...
* Wed Aug 26 2026 Brian Read <brianr@koozali.org> 11.0.0-249.sme
- CSRF Token missing from DNF update request in DNF panel [SME: 13713]
...
- Fix display of lexical string after error [SME: 13450]
...
* Sun Jul 19 2026 Brian Read <brianr@koozali.org> 11.0.0-220.sme
- The last of UTF8 calls when opening DBs [SME: 13663]
...
* Tue Mar 24 2026 Brian Read <brianr@koozali.org> 11.0.0-188.sme
- Restore missing > on <a> tag places where the following line has been commented out [SME: 6278]

* Tue Mar 24 2026 Brian Read <brianr@koozali.org> 11.0.0-187.sme
- Fix 'label for' violations in datetime, dnf software install and mail log file panels [SME: 6278]
...
* Sun Feb 01 2026 Brian Read <brianr@koozali.org> 11.0.0-161.sme
- Make sure all lex files referenced in controller and template files are in english lex file for each module [SME: 13396]
...
* Mon Jan 12 2026 Brian Read <brianr@koozali.org> 11.0.0-155.sme
- Add lex prefix to ftp options in en lex file [SME: 13397]
