...
'mai_LABEL_WEBMAIL_ACCESS_CONTROL' => 'Webmail access',
...
'mai_DESC_PEERPORT' => 'Usually 25, 587 or 465. If empty will assume 25.',
'mai_FRONT_panel_action_was_successful' => 'Front panel action was successful',
'mai_Authentication_allowed_(LAN)' => 'Authentication allowed (LAN)',
'mai_Enabled_for_local_access_only' => 'Enabled for local access only',
'mai_Enabled_for_local_and_public_access' => 'Enabled for local and public access',
'mai_Enabled_for_public_SSL_only' => 'Enabled for public SSL only',
'mai_No_Authentication' => 'No Authentication',
'mai_Authentication_allowed_(LAN_and_public)' => 'Authentication allowed (LAN and public)',
'mai_ERROR_UPDATING_CONFIGURATION' => 'ERROR_UPDATING_CONFIGURATION',
