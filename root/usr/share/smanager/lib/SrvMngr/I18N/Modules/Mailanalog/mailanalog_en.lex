...
'mai_INITIAL_DESC' => 'Analysing the mail system log files can aid both in
...
'mai_Daily_Summary_Report_today' => 'Summary report for today up to now',
'mai_Daily_Summary_Report_all' => 'Summary report for all time up to now',
# 'mai_LIST_OUTGOING' => 'List outgoing messages and recipients',
# 'mai_SUMMARIZE_QUEUE' => 'Summarize status of mail queue',
# 'mai_SUCCESSFUL_DELIVERY_DELAY' => 'Successful delivery delay distribution',
# 'mai_REASONS_DEFERRAL' => 'Reasons for deferral',
# 'mai_REASONS_FAILURE' => 'Reasons for failure',
# 'mai_BASIC_STATS' => 'Basic statistics',
# 'mai_RECIP_STATS' => 'Recipients statistics',
# 'mai_RECIP_HOSTS' => 'Recipient hosts',
# 'mai_RECIP_ORDERED' => 'Recipients in best order for mailing lists',
# 'mai_SENDER_STATS' => 'Sender statistics',
