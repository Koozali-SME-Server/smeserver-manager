...
'STRING_VALIDATION' => 'String should start with a unicode character, could then contains unicode characters, hyphens, periods, underscores, single quote, backtick, comma or space. It can not be empty.',
#'PHONE_VALIDATION' => 'Phone string could be a simple short 2-5 extension. Alternatively, it is expected to have: optional country code, optional 3-digit area code, required 3-digit exchange + 4-digit line number, and optional 2 to 5 digit extension after a comma.',
'PHONE_VALIDATION' => 'Please enter a valid phone number (7-15 digits, optionally starting with + or 00 for an international code, with spaces, dashes, or dots between groups), or a short extension (2-5 digits).',
